            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-clr-login p-6 text-center align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="h3"
                    className=" mt-10  text-2xl font-normal leading-6 text-black font-fonte-padrao"
                  >
                    Tem certeza que deseja adicionar esta questão ao PDI?
                  </Dialog.Title>

                  <h2 className="mb-5 text-red-500 font-fonte-padrao">
                    Ela não poderá ser apagada, apenas arquivada
                  </h2>
